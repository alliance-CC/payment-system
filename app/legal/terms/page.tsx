...
// まもるん有無で会費が変わるため両方を併記する (規約の会費表と整合させる)。
// 規約ページ自体は まもるん有無で共通 (該当部の適用可否は本文の注記で示す)。
const PLANS = [
  {
    id: "plus", name: "暮らし安心プラス",
    desc: "近隣トラブル解決支援まもるん ／ ネットライフサポート",
    price: "月額 ¥1,320（税込）／まもるんを含まない場合 ¥990（税込）",
  },
  {
    id: "premium", name: "暮らし安心プレミアム",
    desc: "プラスの内容 ＋ データ復旧 ／ セキュリティ",
    price: "月額 ¥1,870（税込）／まもるんを含まない場合 ¥1,430（税込）",
  },
];
